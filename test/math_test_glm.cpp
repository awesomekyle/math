...
#define CHECK_EQUAL_MAT3(expected, actual)  \
    for(int ii=0;ii<9;++ii) {                   \
        EXPECT_FLOAT_EQ((expected)[ii], (actual)[ii]);    \
    }
 ...
 * Vec2                                                                       *
\******************************************************************************/
struct Vec2Fixture : public Test
{
    glm::vec2   a,b,c;
    Vec2        i,j,k;
    float       s;
...
TEST_F(Vec3Fixture, Vec4FromVec3)
{
...
TEST_F(Vec4Fixture, Vec3FromVec4)
{
...
TEST_F (Mat3Fixture, Mat4FromMat3)
{
...
TEST_F (Mat4Fixture, Mat3FromMat4)
{
...
TEST_F(Mat4Fixture, Mat4Translate)
{
    float x = _rand_float(-50.0f, 50.0f),
          y = _rand_float(-50.0f, 50.0f),
          z = _rand_float(-50.0f, 50.0f);
...
TEST_F(QuaternionFixture, Create)
{
    float x = _rand_float(0.1f, 50.0f),
          y = _rand_float(0.1f, 50.0f),
          z = _rand_float(0.1f, 50.0f);
